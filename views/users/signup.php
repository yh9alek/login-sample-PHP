<form method="POST" class="w-[300px] h-[447.141px] relative 870:w-[60%] 870:mx-auto 710:mx-auto">
    ...
    <div class="signup-b 870:flex 870:flex-row-reverse 870:justify-between 870:items-end">
        <input type="submit" value="Register" class="bg-[#6DABE4] text-white font-poppins text-[14px] py-[15px] px-[39px] mt-[16px] rounded-[5px] hover:cursor-pointer hover:bg-[#4292DC] transition 870:inline-block">
        <a href="/signin" class="text-[14px] text-[#222] underline font-poppins absolute top-[411px] -left-[325px] 990:-left-[270px] 870:top-[407px] 870:inline-block 870:ml-[270px]">I am already member</a>
    <div>
</form>